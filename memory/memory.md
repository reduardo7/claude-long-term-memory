...
The agent reads `docs/vault/Home.md`, `conditional_docs.md` (if it exists), recent daily logs, and `Decisiones/Index.md` — then follows all relevant cross-references in the vault. Returns the full content of each document — without summarizing or paraphrasing.
